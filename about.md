...
<p> He predicted a wearing of machining tools, especially applying deep learning methods and decomposition processes such as Fourier transform, wavelet transform. He also developed the interpretable machine learning model to predict churn of MMORPG(Massively Multiplayer Online Role-Playing Game) users. Furthermore, he proposed the integer programming based promotion strategy to improve retention. </p>
